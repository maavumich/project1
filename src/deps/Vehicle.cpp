...
Vehicle::Vehicle(float xInit,
	...
	body {Rectangle(xInit,yInit,yawInit,Constants::bodyColor,program,
		radiusInit * (float)sin(PI / 4) * 0.8, radiusInit * (float)sin(PI / 4) * 0.8)},
	bar1 {Rectangle(xInit,yInit,yawInit + PI / 4,Constants::barColor,program,
		radiusInit * 2 - 0.01, radiusInit * 0.03)},
	bar2 {Rectangle(xInit,yInit,yawInit - PI / 4,Constants::barColor,program,
		radiusInit * 2 - 0.01, radiusInit * 0.03)},
	playerIdentifier {Circle(xInit,yInit,yawInit,radius * 0.1f,colorIn,program)}
{
	...
	{
		ring.emplace_back(x + radius * cos(theta), y + radius * sin(theta), theta,
